...
class MAST(nn.Module):
    ...
    def __init__(self, label_dim=None, input_tdim=1024, imagenet_pretrain = False, audioset_pretrain = False, model_size='mvit'):
        super(MAST, self).__init__()

        self.mast_model = mast(label_dim=label_dim, input_tdim=input_tdim, imagenet_pretrain = imagenet_pretrain, audioset_pretrain = audioset_pretrain, model_size=model_size)
